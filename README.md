...
This is sql database schema for a company that includes complex structure and design. It is made using popsql. And the schema contains primary and foreign key and composite keys as well. The relation between this key can be clearly seen in the schema image. 
